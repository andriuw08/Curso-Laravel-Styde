...
<html lang="en" class="h-100">
  <head>
    ...
    {{-- Con el yield y el $type.net hacemos que el titulo pueda ser modificado y estatico para todas las paginas  --}}
...
<meta name="theme-color" content="#563d7c">
    ...
    <!-- Custom styles for this template 
        Con el asset en la ruta hacemos que el archivo tengo acceso a la ubicacion correcta desde cualquier parte del archivo
    -->
